...
const Examination = () => {
  ...
  const fetchData = async () => {
    try {
      const [subjectRes, sessionRes, examRes] = await Promise.all([
        axios.get('https://examprep-9ld9.onrender.com/api/subject'),
        axios.get('https://examprep-9ld9.onrender.com/api/session'),
        axios.get('https://examprep-9ld9.onrender.com/api/exams/exams')
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing && editingExamId) {
        await axios.put(`https://examprep-9ld9.onrender.com/api/exams/${editingExamId}`, formData);
        alert('Exam Updated Successfully');
      } else {
        await axios.post('https://examprep-9ld9.onrender.com/api/exams', formData);
  ...
  const handleDelete = async (id) => {
    const res = await axios.delete(`https://examprep-9ld9.onrender.com/api/exams/${id}`);
    if (res) {
